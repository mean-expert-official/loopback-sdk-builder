...
module.exports = function generate(ctx) {
  ...
  **/
  let schema = [
    ...
    {
      template: './shared/actions/user.ejs',
      output: '/actions/user.ts',
      params: { }
    },
    /**
     * NGRX Effects
    ...
    {
      template: './shared/effects/user.ejs',
      output: '/effects/user.ts',
      params: { }
    },
    /**
     * NGRX Guards
    ...
    {
      template: './shared/guards/user-exists.ejs',
      output: '/guards/user-exists.ts',
      params: { }
    },
    {
      template: './shared/guards/user-logged.ejs',
      output: '/guards/user-logged.ts',
      params: { }
    },
    /**
     * NGRX Reducers
    ...
    {
      template: './shared/reducers/user.ejs',
      output: '/reducers/user.ts',
      params: { }
    },
    /**
     * NGRX Resolvers
     */
    {
      template: './shared/resolvers/current-user.ejs',
      output: '/resolvers/current-user.ts',
      params: { }
    },
    {
    ...
    {
      template: './shared/resolvers/user.ejs',
      output: '/resolvers/user.ts',
      params: { }
    }
  ];
