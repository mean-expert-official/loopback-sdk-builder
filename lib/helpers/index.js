      ...
      if (ctx.fireloopOnly === 'disabled' || (ctx.models[modelName].sharedClass.ctor.settings.base === 'User')) {
        schema.push({
          ...
          params: {
            ...
            buildUrlParams,
            buildRouteParams,
            buildMethodParams: ctx.framework === 'react' ? reactBuilder.buildMethodParams : false,
            buildServiceDI: ctx.framework === 'react' ? reactBuilder.buildServiceDI : false,
            buildServiceImports: ctx.framework === 'react' ? reactBuilder.buildServiceImports : false,
            normalizeMethodName,
            buildObservableType,
            paramIsContext,
            paramIsFunction
