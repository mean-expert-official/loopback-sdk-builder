  ...
  **/
  let schema = [
     ...
     */
    {
      ...
      output: '/services/custom/SDKModels.js',
      params: { models: ctx.models }
    },
    /**
     * SDK CONFIG
    ...
    },
    {
      ...
      output: '/services/core/error.service.js',
      params: {}
    },
    {
      template: './shared/services/core/logger.ejs',
      output: '/services/custom/logger.service.js',
      params: {}
    },
    {
      template: './shared/services/core/search.ejs',
      output: '/services/core/search.params.js',
      params: {}
    },
    /**
     * STORAGE
     */
    {
      template: './shared/storage/storage.swaps.js',
      output: '/storage/storage.swaps.js',
      params: {}
    }
  ];
  ...
  if (ctx.driver.match(/ng2web|ng2universal/)) {
    schema.push({
      template: './shared/storage/cookie.browser.js',
      output: '/storage/cookie.browser.js',
      params: {}
    });
    schema.push({
      template: './shared/storage/storage.browser.js',
      output: '/storage/storage.browser.js',
      params: {}
    });
  }
  ...
  if (ctx.driver === 'ng2universal') {
    schema.push({
      template: './shared/storage/cookie.node.js',
      output: '/storage/cookie.node.js',
      params: {}
    });
  }
  ...
  if (ctx.driver === 'ng2native') {
    schema.push({
      template: './shared/storage/storage.native.js',
      output: '/storage/storage.native.js',
      params: {}
    });
  }
  /**
  ...
  if (ctx.isIo === 'enabled') {
    ...
    schema = schema.concat([
      {
        template: './shared/sockets/connections.js',
        output: '/sockets/socket.connections.js',
        params: {}
      },
      {
        template: './shared/sockets/socket.driver.js',
        output: '/sockets/socket.driver.js',
        params: {}
      },
      {
        template: './shared/services/core/io.ejs',
        output: '/services/core/io.service.js',
        params: {}
      },
      {
        template: './shared/services/core/realtime.js',
        output: '/services/core/real.time.js',
        params: {}
      },
      {
        template: './shared/models/fireloop.ejs',
        output: '/models/FireLoop.js',
        params: {}
      },
      {
        template: './shared/models/flref.js',
        output: '/models/FireLoopRef.js',
        params: {}
      }
    ]);
    // Add Browser Specific Code
    if (ctx.driver.match(/ng2web|ng2universal/)) {
      schema.push({
        template: './shared/sockets/socket.browser.js',
        output: '/sockets/socket.browser.js',
        params: {}
      });
    }
    // Add Server Specific Code
    if (ctx.driver === 'ng2universal') {
      schema.push({
        template: './shared/sockets/socket.node.js',
        output: '/sockets/socket.node.js',
        params: {}
      });
    }
    // Add NativeScript Specific Code
    if (ctx.driver === 'ng2native') {
      schema.push({
        template: './shared/sockets/socket.native.js',
        output: '/sockets/socket.native.js',
        params: {}
      });
    }
  }
      ...
      */
      if (ctx.fireloopOnly === 'disabled' || (ctx.models[modelName].sharedClass.ctor.settings.base === 'User')) {
        schema.push({
          ...
          output: '/services/custom/' + modelName + '.js',
          params: {
            isIo: ctx.isIo,
            model: ctx.models[modelName],
            modelName: modelName,
