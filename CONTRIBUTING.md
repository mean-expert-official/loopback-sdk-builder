...
Thank you for your interest in `loopback-sdk-angular`, an open source project
administered by StrongLoop.

Contributing to `loopback-sdk-angular` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/loopback-sdk-angular)
