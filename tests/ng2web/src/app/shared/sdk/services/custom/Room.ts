...
export class RoomApi extends BaseLoopBackApi {
  ...
  public onPatchOrCreate(): Observable<any> {
    let _method: string = "PATCH";
    let _url: string = "/" + LoopBackConfig.getApiVersion() +
    "/rooms";
    let _routeParams: any = {};
  ...
  public onPatchAttributes(id: any): Observable<any> {
    let _method: string = "PATCH";
    let _url: string = "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyCategories(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/categories";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyAccounts(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/accounts";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyAdmins(id: any, data: any[] = []): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/rooms/:id/admins";
    let _routeParams: any = {
