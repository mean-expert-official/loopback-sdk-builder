...
/**
 * Api services for the `RoomAdmin` model.
 */
@Injectable()
export class RoomAdminApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `RoomAdmin` object.)
   * </em>
   */
  public getAccount(id: any, refresh: any = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/room-admins/:id/account";
